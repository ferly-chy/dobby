...
static uint8_t read_byte(x86_insn_reader_t *rd) {
  X86_INSN_DEBUG_LOG("[x86 insn reader] %p - 1", rd->buffer_cursor);
...
static uint16_t read_word(x86_insn_reader_t *rd) {
  X86_INSN_DEBUG_LOG("[x86 insn reader] %p - 2", rd->buffer_cursor);
...
static uint32_t read_dword(x86_insn_reader_t *rd) {
  X86_INSN_DEBUG_LOG("[x86 insn reader] %p - 4", rd->buffer_cursor);
...
static uint64_t read_qword(x86_insn_reader_t *rd) {
  X86_INSN_DEBUG_LOG("[x86 insn reader] %p - 8", rd->buffer_cursor);
